...
{
    /// <summary>
    /// Environment.SpecialFolder doesn't contain all special folders. If you need more folders (for example, "Downloads"), use KnownFolders.
    /// Just get the guid from somewhere and add it to KnownFolderGuids and add an enum member to KnownFolder.
    /// <see cref="KnownFolderGuids"/>
    /// <see cref="KnownFolder"/>
    /// Exmple usage: var downloads = KnownFolders.GetPath(KnownFolder.Downloads);
    /// </summary>
    public static class KnownFolders
    {
        ...
        /// <summary>
        /// Gets the print folder for this project.
        /// </summary>
        /// <returns></returns>
        public static string GetPrintFolder()
        {
            return GetPath(KnownFolder.Documents) + @"\CsvExport";
        }
